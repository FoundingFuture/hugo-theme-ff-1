...
| `contract.toml`, `docs/front-matter.md` | Generated by `./c docs`. What the templates read |
| `docs/how-to-write-a-hugo-theme.md` | What building this one taught, and what reading Congo, hugo-book and PaperMod taught |
