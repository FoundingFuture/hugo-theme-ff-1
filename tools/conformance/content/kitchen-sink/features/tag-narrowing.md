...
description = 'The fixture page for the tag-narrowing feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  tag-narrowing = true
+++

This page exercises the tag-narrowing feature. The switch above turns it on,
