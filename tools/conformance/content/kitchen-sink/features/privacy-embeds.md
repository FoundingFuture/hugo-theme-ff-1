...
description = 'The fixture page for the privacy-embeds feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  privacy-embeds = true
+++

This page exercises the privacy-embeds feature. The switch above turns it on,
