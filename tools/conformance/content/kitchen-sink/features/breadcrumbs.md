...
description = 'The fixture page for the breadcrumbs feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  breadcrumbs = true
+++

This page exercises the breadcrumbs feature. The switch above turns it on,
