...
description = 'The fixture page for the figure-captions feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  figure-captions = true
+++

This page exercises the figure-captions feature. The switch above turns it on,
