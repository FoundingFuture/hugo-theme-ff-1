...
description = 'The fixture page for the further-down feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  further-down = true
+++

This page exercises the further-down feature. The switch above turns it on,
