...
description = 'The fixture page for the term-header feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  term-header = true
+++

This page exercises the term-header feature. The switch above turns it on,
