...
description = 'The fixture page for the pager feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  pager = true
+++

This page exercises the pager feature. The switch above turns it on,
