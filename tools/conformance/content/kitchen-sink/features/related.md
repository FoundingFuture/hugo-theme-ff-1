...
description = 'The fixture page for the related feature, which turns the switch on so that what the manifest declares can be seen.'
[params.features]
  related = true
+++

This page exercises the related feature. The switch above turns it on,
