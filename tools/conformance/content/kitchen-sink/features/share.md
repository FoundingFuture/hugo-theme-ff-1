...
description = 'The fixture page for the share feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  share = true
+++

This page exercises the share feature. The switch above turns it on,
