...
description = 'The fixture page for the dateline feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  dateline = true
+++

This page exercises the dateline feature. The switch above turns it on,
