...
description = 'The fixture page for the code-copy feature, which turns the switch on so that what the manifest declares can be seen.'
[params.features]
  code-copy = true
+++

This page exercises the code-copy feature. The switch above turns it on,
