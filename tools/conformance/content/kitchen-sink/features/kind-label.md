...
description = 'The fixture page for the kind-label feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1]
  kind = 'hugo theme'
  colour = 'indigo'
...
This page exercises the kind-label feature. The switch above turns it on,
