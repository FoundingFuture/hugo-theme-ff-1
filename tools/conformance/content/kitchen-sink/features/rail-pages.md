...
description = 'The fixture page for the rail-pages feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  rail-pages = true
+++

This page exercises the rail-pages feature. The switch above turns it on,
