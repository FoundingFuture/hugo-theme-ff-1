...
description = 'The fixture page for the search feature, which turns the switch on so that what the manifest declares can be seen.'
[params.ff-1.features]
  search = true
+++

This page exercises the search feature. The switch above turns it on,
