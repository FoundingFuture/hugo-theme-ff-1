...
gate_checks() {
  case "$1" in
    ...
    output)  echo "conform validity head a11y contrast perf external nojs feeds search expect band visual" ;;
    release) echo "changelog version listing module demo downstream" ;;
    *)       return 1 ;;
  esac
}
