...
#
# The namespace is written into the generated partials. A partial
# cannot ask which theme it belongs to. That makes it a second spelling
# of a name slug.sh already defines. A second spelling is the one that
# goes stale, so it is tested here.
#
